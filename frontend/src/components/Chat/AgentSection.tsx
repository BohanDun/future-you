  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: nextId(),
      role: 'agent',
      text: "I'm your Future You coach — ask me anything about money: a purchase, saving, investing basics, opening an account, or a 'what if' with a dollar amount.",
    },
  ]);
        ...
        <Stack spacing={2}>
          ...
          <Stack direction="row" spacing={1}>
            <TextField
              fullWidth
              size="small"
              placeholder="Ask me anything — e.g. Should I invest? What if I buy a $2,000 laptop?"
              value={input}
              disabled={busy}
